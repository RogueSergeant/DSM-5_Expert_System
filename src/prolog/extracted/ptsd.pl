...
%% Note: Includes criteria for adults/adolescents/children >6 years and
%% separate criteria for children ≤6 years.
%% =============================================================================
...
%% =============================================================================
%% Criterion A: Trauma Exposure Symptoms (Adults/Adolescents/Children >6)
%% =============================================================================
...
%% =============================================================================
%% Criterion A: Trauma Exposure Symptoms (Children ≤6 years)
%% =============================================================================

symptom(ptsd, ptsd_a1_child, trauma_exposure_child, 'Directly experiencing the traumatic event(s) (child ≤6 years)').
symptom(ptsd, ptsd_a2_child, trauma_exposure_child, 'Witnessing, in person, the event(s) as it occurred to others, especially primary caregivers (child ≤6 years; not electronic media)').
symptom(ptsd, ptsd_a3_child, trauma_exposure_child, 'Learning that the traumatic event(s) occurred to a parent or caregiving figure (child ≤6 years)').

%% =============================================================================
%% Criterion B: Intrusion Symptoms (Adults/Adolescents/Children >6)
%% =============================================================================
...
symptom(ptsd, ptsd_b1_child, intrusion_child, 'Recurrent, involuntary, and intrusive distressing memories of the traumatic event(s) (may appear as play reenactment in children ≤6)').
symptom(ptsd, ptsd_b2_child, intrusion_child, 'Recurrent distressing dreams related to the traumatic event(s) (may not be possible to ascertain frightening content is trauma-related in children ≤6)').
symptom(ptsd, ptsd_b3_child, intrusion_child, 'Dissociative reactions in which the child feels or acts as if the traumatic event(s) were recurring (trauma-specific reenactment may occur in play)').
symptom(ptsd, ptsd_b4_child, intrusion_child, 'Intense or prolonged psychological distress at exposure to internal or external cues that symbolize or resemble an aspect of the traumatic event(s) (child ≤6)').
symptom(ptsd, ptsd_b5_child, intrusion_child, 'Marked physiological reactions to reminders of the traumatic event(s) (child ≤6)').

%% =============================================================================
%% Criterion C: Avoidance Symptoms (Adults/Adolescents/Children >6)
%% =============================================================================
...
%% Note: For children ≤6, C criterion combines avoidance and negative alterations
%% =============================================================================

symptom(ptsd, ptsd_c1_child, avoidance_cognition_child, 'Avoidance of or efforts to avoid activities, places, or physical reminders that arouse recollections of the traumatic event(s) (child ≤6)').
symptom(ptsd, ptsd_c2_child, avoidance_cognition_child, 'Avoidance of or efforts to avoid people, conversations, or interpersonal situations that arouse recollections of the traumatic event(s) (child ≤6)').
symptom(ptsd, ptsd_c3_child, avoidance_cognition_child, 'Substantially increased frequency of negative emotional states (e.g., fear, guilt, sadness, shame, confusion) (child ≤6)').
symptom(ptsd, ptsd_c4_child, avoidance_cognition_child, 'Markedly diminished interest or participation in significant activities, including constriction of play (child ≤6)').
symptom(ptsd, ptsd_c5_child, avoidance_cognition_child, 'Socially withdrawn behavior (child ≤6)').
symptom(ptsd, ptsd_c6_child, avoidance_cognition_child, 'Persistent reduction in expression of positive emotions (child ≤6)').

%% =============================================================================
%% Criterion D: Negative Alterations in Cognitions/Mood (Adults/Adolescents/Children >6)
%% =============================================================================
...
%% =============================================================================
%% Criterion E: Alterations in Arousal/Reactivity (Adults/Adolescents/Children >6)
%% =============================================================================
...
symptom(ptsd, ptsd_d1_child, arousal_reactivity_symptoms_child, 'Irritable behavior and angry outbursts (with little or no provocation) typically expressed as verbal or physical aggression toward people or objects, including extreme temper tantrums (child ≤6)').
symptom(ptsd, ptsd_d2_child, arousal_reactivity_symptoms_child, 'Hypervigilance (child ≤6)').
symptom(ptsd, ptsd_d3_child, arousal_reactivity_symptoms_child, 'Exaggerated startle response (child ≤6)').
symptom(ptsd, ptsd_d4_child, arousal_reactivity_symptoms_child, 'Problems with concentration (child ≤6)').
symptom(ptsd, ptsd_d5_child, arousal_reactivity_symptoms_child, 'Sleep disturbance (e.g., difficulty falling or staying asleep or restless sleep) (child ≤6)').
...
%% =============================================================================
%% Symptom Categories (Children ≤6 years)
%% =============================================================================

symptom_category(ptsd, trauma_exposure_child,
    [ptsd_a1_child, ptsd_a2_child, ptsd_a3_child],
    1, at_least).

symptom_category(ptsd, intrusion_symptoms_child, 
    [ptsd_b1_child, ptsd_b2_child, ptsd_b3_child, ptsd_b4_child, ptsd_b5_child], 
    1, at_least).

symptom_category(ptsd, avoidance_cognition_symptoms_child, 
    [ptsd_c1_child, ptsd_c2_child, ptsd_c3_child, ptsd_c4_child, ptsd_c5_child, ptsd_c6_child], 
    1, at_least).

symptom_category(ptsd, arousal_reactivity_symptoms_child, 
...
subjective_criterion(ptsd, ptsd_subj_distress_child,
    'The disturbance causes clinically significant distress or impairment in relationships with parents, siblings, peers, or other caregivers or with school behavior (children ≤6 years)',
    clinical_significance).
...
%% =============================================================================
%% Note: Age-Based Criteria Selection
%% =============================================================================
%% PTSD uses entirely separate criteria for children ≤6 years (the _child
%% symptom categories) rather than age-adjusted counts. The inference engine
%% should select the appropriate category set based on patient age:
%%
%%   Adults/adolescents/children >6:
%%     - trauma_exposure, intrusion_symptoms, avoidance_symptoms,
%%       negative_cognition_mood_symptoms, arousal_reactivity_symptoms
%%
%%   Children ≤6:
%%     - trauma_exposure_child, intrusion_symptoms_child,
%%       avoidance_cognition_symptoms_child, arousal_reactivity_symptoms_child
%%
%% age_adjusted_count/4 is NOT used for PTSD since it modifies counts within
%% the same category, whereas PTSD requires switching to different categories.
%% =============================================================================

%% =============================================================================
%% End of PTSD Definition
%% =============================================================================